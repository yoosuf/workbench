...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center rounded-lg bg-[#0d1117] p-1 text-[#8b949e] border border-[#30363d]',
      className
    )}
    {...props}
  />
